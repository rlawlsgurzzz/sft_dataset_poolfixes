...
| key | current_ratio | target_ratio | count |
|---|---:|---:|---:|
| explicit_actor | 57.5% | 40% | 2353 |
| explicit_multi_actor | 14.7% | 12% | 600 |
...
| key | current_ratio | target_ratio | count |
|---|---:|---:|---:|
| explicit_enemy_target | 27.8% | 21% | 1137 |
...
| empty_action_expected | 21.6% | 12% | 885 |

## Command Style

| key | current_ratio | target_ratio | count |
|---|---:|---:|---:|
| direct_korean | 31.7% | 35% | 1295 |
| casual_korean | 30.8% | 20% | 1261 |
...
| skill_actor_has_no_skill | 5.8% | 7% | 57 |
